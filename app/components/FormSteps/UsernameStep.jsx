...
const UsernameStep = ({ formData, handleChange, error, onSubmit, onPrevious, isSubmitting }) => {
  return (
  <>
    <h2 className="text-md sm:text-lg text-lg font-bold mb-1 text-violet-800 text-center">Enter Your Username</h2>
